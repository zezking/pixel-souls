export default class Player extends Phaser.Physics.Matter.Sprite {
  ...
  static preload(scene) {
    scene.load.atlas('ashen_one','assets/character_sprites/ashen_one.png','assets/character_sprites/ashen_one_atlas.json')
    scene.load.animation('ashen_anim','assets/character_sprites/ashen_one_anim.json')
  }
